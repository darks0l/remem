...
declare const smartRecallResultSchema: z.ZodObject<{
    ...
    accessCount: number;
    reasons: string[];
    sourceLane: "graph" | "recent" | "procedural" | "semantic";
...
declare const contextPackSectionSchema: z.ZodObject<{
    ...
    content: string;
    kind: "graph" | "recent" | "overview" | "recall" | "procedural" | "actions" | "dream";
    title: string;
    sourceIds: string[];
}, {
    content: string;
